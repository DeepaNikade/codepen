...
const Login = () => {
  ...
  const {setIsLoggedIn , toast , setLoader , setUserData , setPenData} = useContext(UserContext)
  ...
  const loginUser = async () => {
    try {
      ...
      if (docSnap.exists()) {
        ...
        setUserData([{name : userDataFromFirestore.name , ...userData }])
      }else {
        console.log("");
      }
      setIsLoggedIn(true);
    ...
    <div className="loginbox">
      <div className="login">
        <div className="login-header">
          <div className="logo">
            <img
              src="https://cpwebassets.codepen.io/assets/logos/codepen-logo-eccd67a3067908687f74b7725787a321b0a13ce18601ba839aaab2bd8df9d772.svg"
              alt=""
            />
          </div>
        ...
        <div className="login-section">
          <div className="login-accounts-list">
            <div className="google">
              <button onClick={handleGoogleSignIn}>
                <svg width="26" height="26" viewBox="0 0 186.69 190.5">
          ...
          <div className="form">
            <div className="username-email common">
        ...
        <p className="needAccount">
          Need an account? <NavLink to={"/auth/signup"}>Sign up now!</NavLink>
        </p>
      </div>
    </div>
  );
